...
async function run() {
  try {
    const homesCollection = client.db('aircnc200').collection('homes');
    const usersCollection = client.db('aircnc200').collection('users');
    const bookingsCollection = client.db('aircnc200').collection('bookings');
